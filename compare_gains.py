...
if __name__ == "__main__":
    ...
    """
    """
    calib_ID_number = '00116025000'
    channel_name = 'ChargeLight_32225b771ff_ch60'
    Mother_of_Spreadsheet_name = 'Mother_of_All_Spreadsheets - Mapping 2024.3.20.csv'
    select_channel_by_Mother_of_Spreadsheet(calib_ID_number, channel_name, Mother_of_Spreadsheet_name)
    """
    """
    channel_name = 'ChargeLight_0CD94138_ch46'
    file_path = "/home/jan/Universitat_Bern/Doktor/ADC_Viewer/2024.05.08.14.59.25.json"
    json_data = read_json_file(file_path)
    #print(json_data)
    #print(json_data[0].keys())
    for entry in json_data:
        print(entry.get("calib_run")) #channels to check for
        data_name = entry.get("calib_run").rsplit('/')[-1][:-5]
        #print(data_name)
        #print(entry.get("adc_serials")) #file names
        #print(entry.get("local_channels")) #file names
        select_channel_by_JSON_file(channel_name, json_data)
    """